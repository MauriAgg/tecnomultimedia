class personaje {
  ...
  colisiones() {
    if (this.posX + this.tamx > this.hitbox.posx0 && this.posX < this.hitbox.posx0 + this.hitbox.tamautox &&
      this.posY + this.tamy > this.hitbox.posy0 && this.posY < this.hitbox.posy0 + this.hitbox.tamautoy) {
